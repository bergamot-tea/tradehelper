...
schedule.every().hour.at(":05").do(get_from_gateio, 'TONCOIN_USDT', '1h', '200', 'gateio_v1_roma', '1d', 24)
schedule.every().hour.at(":05").do(get_from_gateio, 'TONCOIN_USDT', '1h', '200', 'gateio_v1_dasha', '1d', 24)
schedule.every().hour.at(":05").do(get_from_gateio, 'TONCOIN_USDT', '1h', '200', 'gateio_v1_alisa', '1d', 24)

schedule.every().hour.at(":05").do(get_from_gateio, 'BTC_USDT', '1h', '200', 'gateio_v1_roma', '1d', 24)
schedule.every().hour.at(":05").do(get_from_gateio, 'BTC_USDT', '1h', '200', 'gateio_v1_dasha', '1d', 24)
schedule.every().hour.at(":05").do(get_from_gateio, 'BTC_USDT', '1h', '200', 'gateio_v1_alisa', '1d', 24)

schedule.every().hour.at(":05").do(get_from_gateio, 'ETH_USDT', '1h', '200', 'gateio_v1_roma', '1d', 24)
schedule.every().hour.at(":05").do(get_from_gateio, 'ETH_USDT', '1h', '200', 'gateio_v1_dasha', '1d', 24)
schedule.every().hour.at(":05").do(get_from_gateio, 'ETH_USDT', '1h', '200', 'gateio_v1_alisa', '1d', 24)

schedule.every().hour.at(":05").do(get_from_gateio, 'BNB_USDT', '1h', '200', 'gateio_v1_roma', '1d', 24)
schedule.every().hour.at(":05").do(get_from_gateio, 'BNB_USDT', '1h', '200', 'gateio_v1_dasha', '1d', 24)
schedule.every().hour.at(":05").do(get_from_gateio, 'BNB_USDT', '1h', '200', 'gateio_v1_alisa', '1d', 24)

schedule.every().hour.at(":05").do(get_from_gateio, 'DOGE_USDT', '1h', '200', 'gateio_v1_roma', '1d', 24)
schedule.every().hour.at(":05").do(get_from_gateio, 'DOGE_USDT', '1h', '200', 'gateio_v1_dasha', '1d', 24)
schedule.every().hour.at(":05").do(get_from_gateio, 'DOGE_USDT', '1h', '200', 'gateio_v1_alisa', '1d', 24)

schedule.every().hour.at(":05").do(get_from_gateio, 'ADA_USDT', '1h', '200', 'gateio_v1_roma', '1d', 24)
schedule.every().hour.at(":05").do(get_from_gateio, 'ADA_USDT', '1h', '200', 'gateio_v1_dasha', '1d', 24)
schedule.every().hour.at(":05").do(get_from_gateio, 'ADA_USDT', '1h', '200', 'gateio_v1_alisa', '1d', 24)

schedule.every().hour.at(":05").do(get_from_gateio, 'TRX_USDT', '1h', '200', 'gateio_v1_roma', '1d', 24)
schedule.every().hour.at(":05").do(get_from_gateio, 'TRX_USDT', '1h', '200', 'gateio_v1_dasha', '1d', 24)
schedule.every().hour.at(":05").do(get_from_gateio, 'TRX_USDT', '1h', '200', 'gateio_v1_alisa', '1d', 24)

schedule.every().hour.at(":05").do(get_from_gateio, 'XRP_USDT', '1h', '200', 'gateio_v1_roma', '1d', 24)
schedule.every().hour.at(":05").do(get_from_gateio, 'XRP_USDT', '1h', '200', 'gateio_v1_dasha', '1d', 24)
schedule.every().hour.at(":05").do(get_from_gateio, 'XRP_USDT', '1h', '200', 'gateio_v1_alisa', '1d', 24)


#--------------------------------- 1h прогноз каждые 10 минут -------------------------------------------
schedule.every(10).minutes.at(":01").do(get_from_gateio, 'TONCOIN_USDT', '5m', '200', 'gateio_v1_roma', '1h', 12)
schedule.every(10).minutes.at(":01").do(get_from_gateio, 'TONCOIN_USDT', '5m', '200', 'gateio_v1_dasha', '1h', 12)
schedule.every(10).minutes.at(":01").do(get_from_gateio, 'TONCOIN_USDT', '5m', '200', 'gateio_v1_alisa', '1h', 12)

schedule.every(10).minutes.at(":01").do(get_from_gateio, 'BTC_USDT', '5m', '200', 'gateio_v1_roma', '1h', 12)
schedule.every(10).minutes.at(":01").do(get_from_gateio, 'BTC_USDT', '5m', '200', 'gateio_v1_dasha', '1h', 12)
schedule.every(10).minutes.at(":01").do(get_from_gateio, 'BTC_USDT', '5m', '200', 'gateio_v1_alisa', '1h', 12)

schedule.every(10).minutes.at(":01").do(get_from_gateio, 'ETH_USDT', '5m', '200', 'gateio_v1_roma', '1h', 12)
schedule.every(10).minutes.at(":01").do(get_from_gateio, 'ETH_USDT', '5m', '200', 'gateio_v1_dasha', '1h', 12)
schedule.every(10).minutes.at(":01").do(get_from_gateio, 'ETH_USDT', '5m', '200', 'gateio_v1_alisa', '1h', 12)

schedule.every(10).minutes.at(":01").do(get_from_gateio, 'BNB_USDT', '5m', '200', 'gateio_v1_roma', '1h', 12)
schedule.every(10).minutes.at(":01").do(get_from_gateio, 'BNB_USDT', '5m', '200', 'gateio_v1_dasha', '1h', 12)
schedule.every(10).minutes.at(":01").do(get_from_gateio, 'BNB_USDT', '5m', '200', 'gateio_v1_alisa', '1h', 12)

schedule.every(10).minutes.at(":01").do(get_from_gateio, 'DOGE_USDT', '5m', '200', 'gateio_v1_roma', '1h', 12)
schedule.every(10).minutes.at(":01").do(get_from_gateio, 'DOGE_USDT', '5m', '200', 'gateio_v1_dasha', '1h', 12)
schedule.every(10).minutes.at(":01").do(get_from_gateio, 'DOGE_USDT', '5m', '200', 'gateio_v1_alisa', '1h', 12)

schedule.every(10).minutes.at(":01").do(get_from_gateio, 'ADA_USDT', '5m', '200', 'gateio_v1_roma', '1h', 12)
schedule.every(10).minutes.at(":01").do(get_from_gateio, 'ADA_USDT', '5m', '200', 'gateio_v1_dasha', '1h', 12)
schedule.every(10).minutes.at(":01").do(get_from_gateio, 'ADA_USDT', '5m', '200', 'gateio_v1_alisa', '1h', 12)

schedule.every(10).minutes.at(":01").do(get_from_gateio, 'TRX_USDT', '5m', '200', 'gateio_v1_roma', '1h', 12)
schedule.every(10).minutes.at(":01").do(get_from_gateio, 'TRX_USDT', '5m', '200', 'gateio_v1_dasha', '1h', 12)
schedule.every(10).minutes.at(":01").do(get_from_gateio, 'TRX_USDT', '5m', '200', 'gateio_v1_alisa', '1h', 12)

schedule.every(10).minutes.at(":01").do(get_from_gateio, 'XRP_USDT', '5m', '200', 'gateio_v1_roma', '1h', 12)
schedule.every(10).minutes.at(":01").do(get_from_gateio, 'XRP_USDT', '5m', '200', 'gateio_v1_dasha', '1h', 12)
schedule.every(10).minutes.at(":01").do(get_from_gateio, 'XRP_USDT', '5m', '200', 'gateio_v1_alisa', '1h', 12)

#--------------------------------- 7d прогноз каждый 1 день -------------------------------------------
schedule.every().day.at("06:07").do(get_from_gateio, 'TONCOIN_USDT', '8h', '200', 'gateio_v1_roma', '7d', 21)
schedule.every().day.at("06:07").do(get_from_gateio, 'TONCOIN_USDT', '8h', '200', 'gateio_v1_dasha', '7d', 21)
schedule.every().day.at("06:07").do(get_from_gateio, 'TONCOIN_USDT', '8h', '200', 'gateio_v1_alisa', '7d', 21)

schedule.every().day.at("06:07").do(get_from_gateio, 'BTC_USDT', '8h', '200', 'gateio_v1_roma', '7d', 21)
schedule.every().day.at("06:07").do(get_from_gateio, 'BTC_USDT', '8h', '200', 'gateio_v1_dasha', '7d', 21)
schedule.every().day.at("06:07").do(get_from_gateio, 'BTC_USDT', '8h', '200', 'gateio_v1_alisa', '7d', 21)

schedule.every().day.at("06:07").do(get_from_gateio, 'ETH_USDT', '8h', '200', 'gateio_v1_roma', '7d', 21)
schedule.every().day.at("06:07").do(get_from_gateio, 'ETH_USDT', '8h', '200', 'gateio_v1_dasha', '7d', 21)
schedule.every().day.at("06:07").do(get_from_gateio, 'ETH_USDT', '8h', '200', 'gateio_v1_alisa', '7d', 21)

schedule.every().day.at("06:07").do(get_from_gateio, 'BNB_USDT', '8h', '200', 'gateio_v1_roma', '7d', 21)
schedule.every().day.at("06:07").do(get_from_gateio, 'BNB_USDT', '8h', '200', 'gateio_v1_dasha', '7d', 21)
schedule.every().day.at("06:07").do(get_from_gateio, 'BNB_USDT', '8h', '200', 'gateio_v1_alisa', '7d', 21)

schedule.every().day.at("06:07").do(get_from_gateio, 'DOGE_USDT', '8h', '200', 'gateio_v1_roma', '7d', 21)
schedule.every().day.at("06:07").do(get_from_gateio, 'DOGE_USDT', '8h', '200', 'gateio_v1_dasha', '7d', 21)
schedule.every().day.at("06:07").do(get_from_gateio, 'DOGE_USDT', '8h', '200', 'gateio_v1_alisa', '7d', 21)

schedule.every().day.at("06:07").do(get_from_gateio, 'ADA_USDT', '8h', '200', 'gateio_v1_roma', '7d', 21)
schedule.every().day.at("06:07").do(get_from_gateio, 'ADA_USDT', '8h', '200', 'gateio_v1_dasha', '7d', 21)
schedule.every().day.at("06:07").do(get_from_gateio, 'ADA_USDT', '8h', '200', 'gateio_v1_alisa', '7d', 21)

schedule.every().day.at("06:07").do(get_from_gateio, 'TRX_USDT', '8h', '200', 'gateio_v1_roma', '7d', 21)
schedule.every().day.at("06:07").do(get_from_gateio, 'TRX_USDT', '8h', '200', 'gateio_v1_dasha', '7d', 21)
schedule.every().day.at("06:07").do(get_from_gateio, 'TRX_USDT', '8h', '200', 'gateio_v1_alisa', '7d', 21)

schedule.every().day.at("06:07").do(get_from_gateio, 'XRP_USDT', '8h', '200', 'gateio_v1_roma', '7d', 21)
schedule.every().day.at("06:07").do(get_from_gateio, 'XRP_USDT', '8h', '200', 'gateio_v1_dasha', '7d', 21)
schedule.every().day.at("06:07").do(get_from_gateio, 'XRP_USDT', '8h', '200', 'gateio_v1_alisa', '7d', 21)
...
schedule.every().day.at("06:17").do(check_predict_true_or_false, '7d')
